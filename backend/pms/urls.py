...
urlpatterns = [
    ...
    path("properties/quotes/", views.property_quotes, name="property-quotes"),
    ...
    path("fleet/service/", views.fleet_service_list, name="fleet-service-list"),
    path("fleet/service/<uuid:property_id>/", views.fleet_service_detail, name="fleet-service-detail"),
    path("contract-templates/", views.contract_template_list, name="contract-template-list"),
    path("contract-templates/<str:kind>/", views.contract_template_detail, name="contract-template-detail"),
    path("reservations/<uuid:reservation_id>/contract/", views.reservation_contract, name="reservation-contract"),
    ...
    path("pricing/preview/", views.pricing_preview, name="pricing-preview"),
    path("pricing-groups/", views.pricing_group_list, name="pricing-group-list"),
    path("pricing-groups/<uuid:group_id>/", views.pricing_group_detail, name="pricing-group-detail"),
    ...
    path("stay-constraints/", views.stay_constraint_list, name="stay-constraint-list"),
    path("stay-constraints/<uuid:constraint_id>/", views.stay_constraint_detail, name="stay-constraint-detail"),
